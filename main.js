...
//-------------------------Question no 11---------------//
let citrusFruits = fruits.slice(0, 2); //Here the slice method is used for the creation of new array from the previous array
console.log(citrusFruits);
//output would be like this=[ 'kiwi', 'orange' ]
//-------------------Question no 12------------------------//
let lastTwo = fruits.slice(-2); //heres the slice method is used to create a new array using the elemets of another array
console.log(lastTwo);
export {};
